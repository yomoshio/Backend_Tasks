...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "APPLICATION FOR TASKS"
    PROJECT_DESCRIPTION: str = "Backend of test application for working with tasks"
    PROJECT_VERSION: str = "7.7.7"
    API_V1_ENDPOINT: str = "/api/v1"

    DATABASE_URL: str = "sqlite://sqlite3.db"

    SECRET_KEY: str = 'TESTAPPLIFORSOMEONEINHH'
    ALGORITHM: str = "HS256"
